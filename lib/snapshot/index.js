...
const abaculus = Promise.promisify( require( '@mapbox/abaculus' ), { multiArgs: true } );
...
function requestHandler( req, res, next ) {
	...
	return Promise.try( () => {
		...
		if ( params.scale !== undefined ) {
			...
			params.scale = params.scale.slice( 1, -1 );
		}
