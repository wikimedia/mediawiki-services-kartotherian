...
module.exports = function snapshot(cor, router) {
  ...
  const httpsDomains = makeDomainValidator(allowedDomains ? allowedDomains.https : undefined, true);
  const httpDomains = makeDomainValidator(allowedDomains ? allowedDomains.http : undefined, true);
